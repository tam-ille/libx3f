...
CFLAGS=-W -Wall  -Wl,--export-dynamic\
	`pkg-config gtk+-3.0 gmodule-2.0 --cflags` \
	-I/usr/lib/glib-2.0/include -I/usr/include/glib-2.0

LDFLAGS=-L./ -lx3f -ljpeg `pkg-config gtk+-3.0 gmodule-2.0 --libs`

libx3f: raw_x3f.o
	$(CC) -shared -Wl,-soname,libx3f.so.0 -o libx3f.so.0.0.1 -lc -lm -lglib-2.0 -fPIC raw_x3f.o
...
x3f_show.o: x3f_show.c x3f_show.h 
